...
sudo cp -rf README COPYING ChangeLog CREDITS.txt skins/ faces_image/ /usr/share/libfetion/
sudo cp -rf fetion_utf8_CN.qm qt_zh_CN.qm sound/ data/ /usr/share/libfetion/
